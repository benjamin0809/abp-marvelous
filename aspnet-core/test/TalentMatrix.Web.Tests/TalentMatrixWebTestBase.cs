...
using TalentMatrix.Models.TokenAuth;
...
{
    public abstract class TalentMatrixWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TalentMatrixWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TalentMatrixWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TalentMatrixDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TalentMatrixDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TalentMatrixDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TalentMatrixDbContext, Task<T>> func)
        {
            T result;
