...
using TalentMatrix.Authentication;

namespace TalentMatrix.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : TalentMatrixControllerBase
    {
                ...
                case AbpLoginResultType.UnknownExternalLogin:
                    {
                        ...
                        return new ExternalAuthenticateResultModel
                        {
                            AccessToken = CreateAccessToken(CreateJwtClaims(loginResult.Identity, null)),
                            ExpireInSeconds = (int)_configuration.Expiration.TotalSeconds
                        };
                    }
                default:
        ...
        private async Task<TalentLoginResult> GetLoginResultAsync(string usernameOrEmailAddress, string password, string Role)
        {
