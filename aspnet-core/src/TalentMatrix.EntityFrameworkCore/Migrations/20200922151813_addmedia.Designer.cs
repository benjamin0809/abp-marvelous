...
namespace TalentMatrix.Migrations
{
    ...
    [Migration("20200922151813_addmedia")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TalentMatrix.Mediae.Media", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TalentMatrix.Org.OrgUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TalentMatrix.Org.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TalentMatrix.Org.School", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TalentMatrix.Org.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TalentMatrix.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TalentMatrix.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TalentMatrix.Org.Student", b =>
                {
                    b.HasOne("TalentMatrix.Org.School", "School")
                        .WithMany("Students")
